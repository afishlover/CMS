namespace InfrastructureLayer {
    public static class Table {
        ...
        public static string ACCOUNTS_TABLE_EMAIL = "Email";
        ...
        internal static string TEACHER_TABLE_USERID = "UserId";
        internal static string USERS_TABLE_ACCOUNTID = "AccountId";
    }
}